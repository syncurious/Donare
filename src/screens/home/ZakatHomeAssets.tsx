...
const ZakatHomeAssets = () => {
  const navigation = useNavigation<NativeStackNavigationProp<UserStackParamList, 'ZakatHomeAssets'>>();
  ...
  const handleNext = () => {
    ...
    navigation.navigate('ZakatBusinessAssets', { homeAssets: JSON.stringify({ cash, gold, silver, otherAssets }) });
  };
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Paragraph color="secondary" style={styles.description}>
        Enter your home assets below. This includes cash, gold, silver, and any other assets you own at home. These values will be used to calculate your zakat.
      </Paragraph>
      <Input
